...
>
  <div class="container mx-auto px-6">
    <div class="flex items-center justify-between">
      <nav class="py-6" aria-label="Main navigation">
        <ul class="flex items-center space-x-8">
          <li class="hidden lg:block">
            <a
              class="font-poppins-heading text-white transition-colors hover:text-primary-200"
              href={resolve("/")}
              aria-label="Home"
            >
          ...
          <li>
            <a
              class="text-lg text-white transition-colors hover:text-primary-200"
              href={resolve("/movies")}
